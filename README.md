...
|:---:|:---:|
|파란색 플레이어 바가 하단에 있고, 빨간색 장애물과 초록색 생명 박스가 위에서 떨어지는 화면\<br\>상단에 점수, 생명, 시간, 스테이지 정보 표시|중앙에 'Game Over\!' 메시지와 최종 점수 표시\<br\>하단에 'Press SPACE to Restart', 'Press ESC to Exit' 안내 표시|

*(참고: 실제 실행 화면 이미지는 프로젝트 저장소에서 확인할 수 있습니다.)*
